    ...
    state: AreYouAtHome || modal = true
        script:
            if (typeof $.session.atHome !== 'undefined') {
                if ($.session.atHome){
                    $reactions.transition('/NoLink/AreYouAtHome/CheckSession');
                }else{
        ...
        state: CheckSession
            ...
            script:
                ...
                if($.session.rebootResult == "No active internet"){
                    ...
                    if ($.session.sessionStatus == 'new') {
                        ...
                        $reactions.transition('/NoLink/AreYouAtHome/CheckSession/NewSessionLessThanFiveMin');
                    }else{
                        if ($.session.sessionStatus == 'old') {
                            // сессия более 5 минут
                            $reactions.transition('/NoLink/AreYouAtHome/CheckSession/NewSessionMoreThanFiveMin');
                        }else{
                            ...
                            if($.session.authorizationType == 4){
                                ...
                                $reactions.transition('/NoLink/AreYouAtHome/CheckSession/NoSession');
                            }
                        }
                    }
                }
            ...
            state: NewSessionLessThanFiveMin
                ...
                script:
                    ...
                    $reactions.transition("/NoLink/AreYouAtHome/CheckSession/NewSessionLessThanFiveMin/Fix");
                        ...
                        state: СatchAll || noContext = true
                            ...
                            script:
                                ...
                                if(countRepeatsInRow() < $injector.noMatchLimit) {
                                    ...
                                    $reactions.transition('/NoLink/AreYouAtHome/CheckSession/NewSessionLessThanFiveMin/Fix/Fail/ToOperator');
                                }
            ...
            state: NewSessionMoreThanFiveMin
                ...
                script:
                    ...
                    $reactions.transition('/NoLink/AreYouAtHome/CheckSession/NewSessionMoreThanFiveMin/Fix');
                ...
                state: Fix
                    ...
                    state: Fail
                        ...
                        script:
                            $.session.intent.stepsCnt++;
                        go!: /NoLink/AreYouAtHome/CheckSession/NewSessionMoreThanFiveMin/Fix/Fail/ToOperator
                    ...
                    state: СatchAll || noContext = true
                        ...
                        script:
                            ...
                            if(countRepeatsInRow() < $injector.noMatchLimit) {
                                ...
                                $reactions.transition('/NoLink/AreYouAtHome/CheckSession/NewSessionMoreThanFiveMin/Fix/Fail/ToOperator');
                            }
            ...
            state: NoSession
                ...
                script:
                    ...
                    if($.session.awaitAction.status){
                        ...
                        if($.session.activeSessionAvailable){
                            $reactions.transition('/NoLink/AreYouAtHome/CheckSession/NoSession/NewSession');
                        }else{
                            $reactions.transition('/NoLink/AreYouAtHome/CheckSession/NoSession/NoNewSession');
                        }
                    }else{
                        $reactions.transition("/AwaitAction/RunAction");
                    }
                ...
                state: NewSession
                    ...
                    state: Fail
                        ...
                        script:
                            $.session.intent.stepsCnt++;
                        go!: /NoLink/AreYouAtHome/CheckSession/NoSession/NewSession/Fail/ToOperator
                    ...
                    state: СatchAll || noContext = true
                        ...
                        script:
                            ...
                            if(countRepeatsInRow() < $injector.noMatchLimit) {
                                ...
                                $reactions.transition('/NoLink/AreYouAtHome/CheckSession/NoSession/NewSession/Fail/ToOperator');
                            }
        ...
        state: AgentRequest || noContext = true
            ...
            elseif: $.session.agentRequestCount < 3
                go!: /NoLink/AreYouAtHome/CheckSession
            else:
                script:
                    announceAudio(audioDict.perevod_na_okc);
                    $.session.callerInput = getIntentParam($.session.intent.currentIntent, 'callerInput') || $.injector.defaultCallerInput;
